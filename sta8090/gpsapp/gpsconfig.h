...
tInt  gnss_flash_erase_priority     = 108;
tInt  gnss_rtc_write_task_priority  = 109;
tInt  waas_task_priority            = 110;
tInt  waas_back_end_task_priority   = 111;
tInt  st_agps_ephmgr_task_priority  = 111;
tInt  nmea_cmdif_task_priority      = 112;
tInt  gnss_navigate_task_priority   = 113;
tInt  st_agps_task_priority         = 254;
tInt  backup_task_priority          = 247;
#elif defined(__linux__)
tInt  c2c_ist_task_priority         = 99;
tInt  gnss_rtc_write_task_priority  = 12;
tInt  gnss_flash_erase_priority     = 11;
tInt  waas_task_priority            = 10;
tInt  waas_back_end_task_priority   = 9;
tInt  st_agps_ephmgr_task_priority  = 9;
tInt  nmea_cmdif_task_priority      = 8;
tInt  gnss_navigate_task_priority   = 7;
tInt  st_agps_task_priority         = 0;
tInt  backup_task_priority          = 1;
#else
tInt  gnss_rtc_write_task_priority    = 12;
tInt  gnss_flash_erase_priority       = 11;
tInt  waas_task_priority              = 10;
