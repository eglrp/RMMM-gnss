...
CSOURCES+=modules/modem/modem.c
CSOURCES+=modules/modem/tools.c
CSOURCES+=modules/modem/at_module.c
CSOURCES+=modules/modem/connection_manager.c
...
CSOURCES+=${MOD_CORE}/gpsapp/main_FR.c
